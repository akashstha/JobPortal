...
export const EditPage = ({updateJobRequest}) => {
    ...
    const [companyName, setCompanyName] = useState(jobs.company.companyName);
    const [companyDescription, setCompanyDescription] = useState(jobs.company.companyDescription);
